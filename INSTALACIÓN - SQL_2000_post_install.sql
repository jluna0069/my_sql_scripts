...
/*
 Pasos que realiza el script:
   ...
   . Pone en 'Autostart' el servicio SQLServerAgent
...
select 'PONE EN "AUTOSTART" EL SERVICIO "SQL SERVER AGENT"'
exec master.dbo.xp_cmdshell 'sc config sqlserveragent start= auto'

select 'ESTADO DEL SERVICIO "SQL SERVER AGENT"'
exec master.dbo.xp_cmdshell 'sc qc sqlserveragent'
