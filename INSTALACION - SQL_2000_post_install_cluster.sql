...
/**********************************************************************
*                                                                     *
*   Configura el SQL Server 2000 en Cluster luego de la instalación   *
*                                                                     *
*                              SQLAdmins                              *
*			                              		      *
...
/* Las versiones de SQL Server probadas son: SQL Server 2000 Enterprise Edition en Cluster.                    */
...
/*
 Pasos que realiza el script:
   ...
   . Agrega a 'SQLAdmins' como SysAdmin, la cuenta del cluster, y quita el acceso a 'Administrators' local
...
select 'AGREGA LA CUENTA DEL SERVICIO CLUSTER'
exec master.dbo.xp_instance_regread 'HKEY_LOCAL_MACHINE', 'SYSTEM\CurrentControlSet\Services\ClusSvc', 'ObjectName', @path_var output
exec master.dbo.sp_grantlogin        @path_var
