...
SELECT 'physical_memory_kb --> Specifies the total amount of physical memory on the machine. Not nullable. Memoria física del servidor'
SELECT 'virtual_memory_kb  --> Specifies the total amount of virtual address space available to the process in user mode. Not nullable. Memoria del VAS asignado al proceso SQLServer.'
SELECT physical_memory_in_bytes/1073741824.0 as [Physical Memory_GB], virtual_memory_in_bytes/1048576.0 as [Virtual Memory MB] FROM sys.dm_os_sys_info
